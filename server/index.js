...
let rooms = {};        // { roomId: [ { id, name }, ... ] }
let roomStates = {};   // { roomId: { movie, strikes, chooserIndex, startTime, revealedLetters } }
let roomScores = {};   // { roomId: { socketId: score, ... } }
let roomTimers = {};   // { roomId: TimeoutObject }

// Utility Functions
const maskMovieName = (movie) => {
...
// Correct Wildcard Route Fallback for SPA
app.use((req, res) => {
